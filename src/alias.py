...
ADJECTIVES = [
    "Ancient", "Blue", "Cosmic", "Dancing", "Electric", "Flying", "Green", "Happy",
    "Iron", "Jolly", "Kind", "Little", "Misty", "Neon", "Orange", "Purple",
    "Quiet", "Red", "Silent", "Tiny", "Urban", "Violet", "Wild", "Yellow",
    "Zealous", "Brave", "Calm", "Eager", "Fancy", "Gentle", "Heavy", "Icy",
    "Lucky", "Merry", "Noble", "Proud", "Rapid", "Sharp", "Tough", "Vivid"
]

NOUNS = [
    "Bear", "Cat", "Dog", "Eagle", "Fox", "Goat", "Hawk", "Ibex",
    "Jay", "Koala", "Lion", "Mouse", "Newt", "Owl", "Pig", "Quail",
    "Rat", "Snake", "Tiger", "Urchin", "Viper", "Wolf", "Yak", "Zebra",
    "Apple", "Book", "Cloud", "Desk", "Echo", "Fire", "Gate", "Hill",
    "Island", "Jewel", "Kite", "Leaf", "Moon", "Note", "Ocean", "Path"
]
